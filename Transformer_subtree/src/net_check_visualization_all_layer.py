...
import pickle
from train_visualization_all_layer import source_pad_concat_convert
...
class MultiHeadAttention(chainer.Chain):
    ...
    def __call__(self, x, z=None, mask=None):
        ...
        self.attention_weight = batch_A._data[0]
...
class Transformer(chainer.Chain):
    ...
    def __init__(self, n_layers, n_source_vocab, n_target_vocab, n_units,
        ...
        #self.one_equation_attention_weight = []
...
#        print("y_in_block.shape:"+str(y_in_block.shape))
        ...
        #self.one_equation_attention_weight = self.encoder.attention_weight_encoder_self_attention
