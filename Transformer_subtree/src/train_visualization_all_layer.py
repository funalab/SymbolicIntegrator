...
#    print(len(x_block))
#    print("文の長さ:"+str(len(x_block[0])))
#    print(xp.full((len(x_block), 1), -1))
    if len(x_block[0]) % 3 != 0:
        ...
        x_block = x_block_add_two_more_padding #更新
    ...
    if len(y_block[0]) % 3 != 0:
        ...
        y_block = y_block_add_two_more_padding #更新
    #y_block_add_two_more_padding = .c_[y_block, xp.full((len(y_seqs), 1), -1)]
    #xp = cuda.get_array_module(x_block)
    ...
    x_block = xp.pad(x_block, ((0, 0), (0, 1)),
                     'constant', constant_values=-1)#2回目
    x_block = xp.pad(x_block, ((0, 0), (0, 1)),
                     'constant', constant_values=-1)#3回目
    for i_batch, seq in enumerate(x_seqs):
        x_block[i_batch, len(seq)] = eos_id
    x_block = xp.pad(x_block, ((0, 0), (1, 0)),
                     'constant', constant_values=bos_id)
    x_block = xp.pad(x_block, ((0, 0), (1, 0)),
                     'constant', constant_values=bos_id)#2回目
    x_block = xp.pad(x_block, ((0, 0), (1, 0)),
                     'constant', constant_values=bos_id)#回目
    ...
    y_in_block = xp.pad(y_in_block, ((0, 0), (1, 0)),
                        'constant', constant_values=bos_id)#2回目
    y_in_block = xp.pad(y_in_block, ((0, 0), (1, 0)),
                        'constant', constant_values=bos_id)#3回目
...
def source_pad_concat_convert(x_seqs, device, eos_id=0, bos_id=2):
    ...
    x_block = xp.pad(x_block, ((0, 0), (0, 1)),
                     'constant', constant_values=-1).astype('i')  # 2回目
    x_block = xp.pad(x_block, ((0, 0), (0, 1)),
                     'constant', constant_values=-1).astype('i')  # 3回目
    ...
    x_block = xp.pad(x_block, ((0, 0), (1, 0)),
                     'constant', constant_values=bos_id).astype('i') # 2回目
    x_block = xp.pad(x_block, ((0, 0), (1, 0)),
                     'constant', constant_values=bos_id).astype('i') # 3回目
...
def main():
    ...
    # Define Model
    model = net_check_visualization.Transformer(
        args.layer,
    ...
    #chainer.serializers.load_npz('./Transformer_combine_onigiri_test_fold0_train_valid_fold0_first_try_epoch300_fix_output_dataset_fix/snapshot_iter_2728', trainer)
    #chainer.serializers.load_npz('./Transformer_combine_onigiri_test_fold0_train_valid_fold1_first_try_epoch300_fix_output_dataset_fix/snapshot_iter_1819', trainer)
    #chainer.serializers.load_npz('./Transformer_combine_onigiri_test_fold0_train_valid_fold2_first_try_epoch300_fix_output_dataset_fix/snapshot_iter_728', trainer)
    #chainer.serializers.load_npz('./Transformer_combine_onigiri_test_fold0_train_valid_fold3_first_try_epoch300_fix_output_dataset_fix/snapshot_iter_546', trainer)
    #chainer.serializers.load_npz('./Transformer_combine_onigiri_test_fold0_train_valid_fold4_first_try_epoch300_fix_output_dataset_fix/snapshot_iter_546', trainer)
    #chainer.serializers.load_npz('./Transformer_combine_onigiri_test_fold0_train_valid_fold5_first_try_epoch300_fix_output_dataset_fix/snapshot_iter_728', trainer)
    #chainer.serializers.load_npz('./Transformer_combine_onigiri_test_fold0_train_valid_fold6_first_try_epoch300_fix_output_dataset_fix/snapshot_iter_546', trainer)
    #chainer.serializers.load_npz('./Transformer_combine_onigiri_test_fold0_train_valid_fold7_first_try_epoch300_fix_output_dataset_fix/snapshot_iter_546', trainer)
    #chainer.serializers.load_npz('./Transformer_combine_onigiri_test_fold0_train_valid_fold8_first_try_epoch300_fix_output_dataset_fix/snapshot_iter_546', trainer)
    chainer.serializers.load_npz('./Transformer_combine_onigiri_test_fold0_train_valid_fold'+str(k_fold_for_train_valid)+'_first_try_epoch300_fix_output_dataset_fix_continue/latest_snapshot', trainer)
